Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://github.com/delightroom/ios-daro-ad-sdk/releases/download/1.0.18/DaroAdSDK.xcframework.zip" }

  s.ios.deployment_target = '13.0'
  s.swift_version = '5.7'

  s.vendored_frameworks = 'DaroAdSDK.xcframework', 'OMSDK-Static_Delightroom.xcframework'
  s.resource_bundles = { 'DaroAdSDK' => ['Resources/*.js'] }
